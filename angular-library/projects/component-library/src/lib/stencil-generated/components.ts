...
@Component({
  selector: 'justifi-additional-questions',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['formController'],
...
export declare interface JustifiAdditionalQuestions extends Components.JustifiAdditionalQuestions {}
...
@Component({
  selector: 'justifi-business-list',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['accountId', 'authToken'],
})
export class JustifiBusinessList {
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
...
export declare interface JustifiBusinessList extends Components.JustifiBusinessList {}
...
@Component({
  selector: 'justifi-business-owners',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['formController'],
})
export class JustifiBusinessOwners {
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
...
export declare interface JustifiBusinessOwners extends Components.JustifiBusinessOwners {}
...
@ProxyCmp({
  inputs: ['formController', 'legend']
})
@Component({
  selector: 'justifi-legal-address-form',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['formController', 'legend'],
...
export declare interface JustifiLegalAddressForm extends Components.JustifiLegalAddressForm {}
...
@Component({
  selector: 'justifi-proceeds-list',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['accountId', 'authToken'],
})
export class JustifiProceedsList {
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
...
export declare interface JustifiProceedsList extends Components.JustifiProceedsList {}


@ProxyCmp({
  inputs: ['columnData', 'errorMessage', 'loading', 'paging', 'rowData']
})
@Component({
  selector: 'justifi-table',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['columnData', 'errorMessage', 'loading', 'paging', 'rowData'],
})
export class JustifiTable {
  protected el: HTMLElement;
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
...
export declare interface JustifiTable extends Components.JustifiTable {}
