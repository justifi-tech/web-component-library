...
export class Dispute implements IDispute {
  ...
  constructor(dispute: IDispute) {
    ...
    this.dispute_response = dispute.dispute_response
      ? new DisputeResponse(dispute.dispute_response)
      : undefined;
  }
}
...
export class DisputeResponse implements IDisputeResponse {
  ...
  constructor(response: IDisputeResponse) {
    ...
    this.duplicate_charge_original_payment_id =
      response.duplicate_charge_original_payment_id;
  }
}
