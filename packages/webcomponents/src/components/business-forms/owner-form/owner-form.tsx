...
export class OwnerForm {
  ...
  get payload() {
    const formValues = new Owner(this.formController.values.getValue()).payload;
    if (this.ownerId) {
      return formValues;
    } else {
  ...
  componentWillLoad() {
    ...
    this.initializeApi();
    this.ownerId && this.getOwner ? this.getData() : this.instantiateOwner({});
  }
          ...
          <fieldset>
            ...
            <div class="row gy-3">
              ...
              <div class="d-flex gap-2 justify-content-start">
                ...
                <Button variant="primary" type="submit" onClick={this.handleAddOwner} disabled={this.isLoading}>
