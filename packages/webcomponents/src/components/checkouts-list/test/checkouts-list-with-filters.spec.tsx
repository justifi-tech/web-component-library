...
const components = [JustifiCheckoutsList, TableFiltersMenu, JustifiCheckoutsListFilters, FormControlSelect];

describe('justifi-checkouts-list with filters', () => {
  const fetchDataSpy = jest.spyOn(JustifiCheckoutsList.prototype, 'fetchData');
  let page;
