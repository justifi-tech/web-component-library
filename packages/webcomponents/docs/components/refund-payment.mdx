---
id: components/refund-payment
title: "&lt;justifi-refund-payment&gt;"
  ...
  rows={[
    {
      ...
      type: 'string',
      required: true,
      description: 'Ensures refunds are scoped to the correct platform account.',
    },
    {
      name: 'auth-token',
      type: 'string',
    ...
    },
    {
      name: 'max-amount',
      type: 'string | number',
      description: 'Upper limit for partial refunds (defaults to remaining amount).',
    },
    {
      name: 'default-reason',
      type: 'string',
...
<PartsTable
  parts={[
    ...
    { name: 'cta', description: 'Refund confirmation button; align with your destructive color palette.' },
  ]}
/>
