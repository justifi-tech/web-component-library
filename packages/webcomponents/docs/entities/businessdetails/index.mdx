...
import { PropsTable, PartsTable, BusinessDetailsExample } from '../../helpers';
...
### Business intake step

Pass the account context plus the business you want to edit.
...
<html dir="ltr" lang="en">
  ...
  <script>
    (function () {
      const businessDetails = document.querySelector(
