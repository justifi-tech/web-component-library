...
import { PropsTable, PartsMarkdownTable, getComponentParts, getWebcomponentsVersion } from '../../helpers';
...
<PartsMarkdownTable
  parts={getComponentParts('justifi-season-interruption-insurance', componentTreeJson)}
/>
