...
- **Props**: Use Angular template syntax for passing props to components. For example, if `cardEnabled` is a variable in your component:

<Source
  language="html"
  dark
  code={dedent(`
    <justifi-payment-form [card]="cardEnabled"></justifi-payment-form>
  `)}
/>
...
<Source
  ...
  dark
  code={dedent(`
    <justifi-payment-form (submitted)="onFormSubmitted($event)"></justifi-payment-form>
  `)}
/>
...
<Source
  ...
  dark
  code={dedent(`
    <justifi-payment-form #paymentForm></justifi-payment-form>
`)}
/>
...
<Source
  ...
  code={dedent(`
    ...
    export class AppComponent implements AfterViewInit {
      ...
      ngAfterViewInit() {
        // Now you can call methods on the web component
        this.paymentFormRef.nativeElement.enableSubmitButton();
      }
    }
