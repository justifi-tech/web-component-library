...
export class BusinessOwners {
  ...
  componentDidLoad() {
    this.formController.values.subscribe(values => {
      if (!isEqual(this.owners, values.owners)) {
        this.owners = [...(values.owners || [])];
      }
    });
    this.formController.errors.subscribe(errors => {
      if (!isEqual(this.errors, errors.owners)) {
            ...
            return (
              <div class="row gx-2 gy-2 mb-4">
                <div class="col-12">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-12 col-md-6">
                        <form-control-text
                          name="postal_code"
                          label="Postal Code"
                          defaultValue={this.owners[index]?.address?.postal_code}
                  ...
                  <button type="button" class="btn btn-danger" onClick={event => this.removeOwner(event, index)}>
                    - Remove owner
                  </button>
                </div>
              </div>
