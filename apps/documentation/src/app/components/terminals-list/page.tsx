...
export default function TerminalsListPage() {
  return (
    <div>
      ...
      <p className="lead">
        The <strong>Terminals List</strong> component displays a list of payment terminals for your business or merchant users.
      </p>
      <Card className="mb-4 p-4 bg-secondary bg-opacity-10 border-0">
        ...
        <div className="my-3 p-3 bg-dark rounded text-center" style={{ minHeight: 120 }}>
          <span className="text-secondary">[Terminals List demo will render here]</span>
        </div>
      </Card>
      <h5>Code Samples</h5>
...
import { JustifiTerminalsList } from '@justifi/webcomponents';

<JustifiTerminalsList />
          `}</code></pre>
        </Tab>
