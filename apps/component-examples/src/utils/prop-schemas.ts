...
export const CHECKOUT_SCHEMA: PropSchema[] = [
  ...
  },
  {
    ...
    required: true,
    validation: {
      pattern: VALIDATION_PATTERNS.CHECKOUT_ID,
    },
  },
  {
...
export const BUSINESS_DETAILS_SCHEMA: PropSchema[] = [
  {
    ...
    required: true,
    validation: {
      pattern: VALIDATION_PATTERNS.BUSINESS_ID,
    },
  },
  {
    name: 'authToken',
...
export const DISPUTE_MANAGEMENT_SCHEMA: PropSchema[] = [
  {
    ...
    required: true,
    validation: {
      pattern: VALIDATION_PATTERNS.DISPUTE_ID,
    },
  },
  {
    name: 'authToken',
...
export const PAYOUT_DETAILS_SCHEMA: PropSchema[] = [
  {
    ...
    required: true,
    validation: {
      pattern: VALIDATION_PATTERNS.PAYOUT_ID,
    },
  },
  {
    name: 'authToken',
