...
import "@justifi/webcomponents/dist/module/justifi-refund-form";
...
const Template = (args: any) => {
  ...
  return `
    ...
    <script>
    (async () => {
      await customElements.whenDefined('justifi-refund-form');
      const refundForm = document.querySelector('justifi-refund-form');
      refundForm.addEventListener('submitted', async (event) => {
        // here is where you would submit a refund with the token
        console.log(event.detail);
        // after the refund succeeds or fails, the form submit button can be enabled again
        await refundForm.enableSubmitButton();
      });
    })()
    </script>
  `;
