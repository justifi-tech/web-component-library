...
- **[`justifi-plaid-payment-method`](/docs/modular-checkout-plaid-payment-method--docs)**: Bank account payment via Plaid Link

### Information Collection Components

- **[`justifi-billing-form-full`](/docs/modular-checkout-billing-form-full--docs)**: Complete billing address collection
- **[`justifi-card-billing-form-simple`](/docs/modular-checkout-card-billing-form-simple--docs)**: ZIP code only billing form for card payments
- **[`justifi-bank-account-billing-form-simple`](/docs/modular-checkout-bank-account-billing-form-simple--docs)**: Account owner name only billing form for ACH payments
...
- **[`justifi-apple-pay`](/docs/modular-checkout-apple-pay--docs)**: Apple Pay button and flow for eligible devices
- **[`justifi-google-pay`](/docs/modular-checkout-google-pay--docs)**: Google Pay button and flow for eligible devices
...
- **`checkout-changed`**: Emitted when the checkout state changes; includes available payment methods and the selected method
