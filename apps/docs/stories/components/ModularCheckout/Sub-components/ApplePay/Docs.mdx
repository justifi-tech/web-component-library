...
Renders an Apple Pay button for provisioned accounts on eligible devices and orchestrates the Apple Pay flow. Designed to be used within `justifi-modular-checkout`.
