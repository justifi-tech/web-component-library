...
- `apple_pay`: Apple Pay is available when enabled by the account and not disabled.
- `google_pay`: Google Pay is available when enabled by the account and not disabled.
