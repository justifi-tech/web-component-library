...
- Using the `<justifi-billing-information-form />` sub component

- Using the `<justifi-postal-code-form />` sub component
...
- `<justifi-billing-information-form />` sub component

- `<justifi-postal-code-form />` sub component
...
You can programmatically set the selected payment method by calling the `setSelectedPaymentMethod` method on the `justifi-modular-checkout` wrapper component. This method takes a payment method ID as a string parameter.
...
modularCheckout.setSelectedPaymentMethod('bankAccount');

// Set to Sezzle BNPL payment method
modularCheckout.setSelectedPaymentMethod('sezzle');

// Set to a specific saved payment method by ID
modularCheckout.setSelectedPaymentMethod('pm_1234567890');
```
