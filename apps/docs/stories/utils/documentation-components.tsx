...
const buildRoles = (props: AuthorizationProps): Role[] => {
  ...
  const { actions, entity, identification } = props;

  if (actions && entity && identification) {
...
export const Authorization = (props: AuthorizationProps) => {
  ...
  const pluralIds = uniqueIds.length > 1;
  const pluralActions = props.actions && props.actions.length > 1;
