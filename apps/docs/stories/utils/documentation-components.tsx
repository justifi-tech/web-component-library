...
const AuthTokenDescription = ({ actions, entity, identification }: AuthorizationProps) => {
  return (
    <>
...
export const Authorization = ({ actions, entity, identification }: AuthorizationProps) => {
  ...
  return (
    <>
      ...
      {isTokenize ? (
        <>
          <p>Authorization can be performed by using a <code>client-id</code> or a <code>web-component-token</code>. Each option has its benefits and drawbacks.
          </p>
          <ul>
            <li>
