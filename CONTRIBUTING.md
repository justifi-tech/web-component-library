...
## Important Links
 - [Web Component Documentation](https://docs.justifi.tech/web-components/introduction)
...
2. In the body of the Issue, enter `/` to select our Bug Reporting Template and fill out each section as required. 

Note: Please include as many details as possible to assist our team in quickly identifying and resolving the issue. 
